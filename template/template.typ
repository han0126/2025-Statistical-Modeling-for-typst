...
#import "template_en.typ": template_en as tg
...
#let contents() = {
  ...
  align(center)[
    #text(font: 字体.黑体, size: 字号.小三)[图#h(0.5em)目#h(0.5em)录]
  ]
  ...
  align(center)[
    #text(font: 字体.黑体, size: 字号.小三)[表#h(0.5em)目#h(0.5em)录]
  ]
...
#let template(body, abstract: [摘要内容], title: "测试题目", keywords: ([key1], [key2], [key3]), abstract_en: [], keywords_en: ([key1], [key1], [key1])) = {
  //设置页面
  set page(
    paper: "a4", 
